...
def updateSituation(system):
    ...
    # system['emq'].des.update_desirability_Function(intent_map, effect_size_of_hir)
    #############################################
...
if __name__ =='__main__':
    ...
    sys.stdout = open("/home/sara.buyukgoz/Desktop/proactive_robot_sim/results/23_09/eqm_cut_s0.txt", "w")
    # try:
    setClasses()
